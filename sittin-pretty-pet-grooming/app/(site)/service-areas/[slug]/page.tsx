...
// Funkstown, Hagerstown, and Halfway each keep their own hand-built static
// page — never generated here.
const PRIMARY_SLUGS = new Set(["funkstown-md", "hagerstown-md", "halfway-md"]);
...
// the sole hero for every town; still real photography, never stock.
const heroPhotos = [
  photos.blackLabSmiling,
  photos.tricolorDogBandana,
  photos.sheepdogBandana,
  photos.tanTerrierMix,
  photos.grayWhiteShihTzu,
  photos.seniorBlackDog,
  photos.tanChihuahua,
  photos.creamFluffyDog,
];
    ...
    <>
      ...
      <section className="mx-auto grid max-w-6xl items-start gap-10 px-4 py-12 lg:grid-cols-2">
        <div>
          ...
          <h1 className="mt-1 font-sp-display text-4xl font-bold text-sp-ink sm:text-5xl">{content.h1}</h1>
          <p className="mt-4 text-lg text-sp-ink-soft">{content.intro}</p>
      ...
      <section className="bg-sp-cream-deep">
        <div className="mx-auto max-w-6xl px-4 py-14">
          <h2 className="font-sp-display text-2xl font-bold text-sp-ink sm:text-3xl">
            Why {area.city} Pet Owners Choose Sittin&apos; Pretty
          </h2>
      ...
      <section className="mx-auto max-w-6xl px-4 py-14">
        <h2 className="font-sp-display text-2xl font-bold text-sp-ink sm:text-3xl">Services Available in {area.city}</h2>
      ...
      <section className="bg-sp-ink text-white">
        <div className="mx-auto flex max-w-3xl flex-col items-center gap-4 px-4 py-14 text-center">
          <h2 className="font-sp-display text-3xl font-bold">Book Grooming From {area.city}</h2>
