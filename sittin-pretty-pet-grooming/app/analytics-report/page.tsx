...
// it renders with none of the public site's header/footer. Kept out of
// search results via metadata below and disallowed in robots.ts.
  ...
  return (
    <div className={shell}>
      <div className="mx-auto max-w-4xl space-y-8">
        <div>
          <h1 className="text-2xl font-bold">Call Click Tracker</h1>
          <p className="mt-1 text-sm text-gray-500">
            Self-hosted click counts for the site&apos;s Call to Schedule buttons — no monthly event cap.
          </p>
        </div>
