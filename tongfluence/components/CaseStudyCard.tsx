...
export function CaseStudyCard({ build, location }: { build: ClientBuild; location: string }) {
  return (
    <Link
      ...
      className="tf-lift group flex h-full flex-col rounded-2xl border border-tf-border bg-tf-card p-6 hover:border-tf-brown focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-tf-brown-dark"
    >
