    ...
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-tf-border bg-white/97 backdrop-blur md:hidden">
      <div className="flex items-center justify-between gap-3 px-4 py-2.5">
        ...
        <Link
          ...
          className="inline-flex min-h-[44px] shrink-0 items-center justify-center rounded-full bg-tf-green-dark px-6 text-sm font-semibold text-white hover:bg-tf-green-darker focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-tf-green-dark"
        >
          Book a call
        </Link>
      </div>
